            ...
            <div class="col-md-6">
              <div class="row">
                  <div class="col col-md-offset-4 reg-form border rounded-2 border border-2 loginborder">
                      <h4>Traveler Registration</h4>
                      <hr><br>
                      <form action="{{route('register-traveler')}}" method="post">
                          @if(Session::has('fail'))
                          ...
                          <div>
                            <input type="hidden" name="usertype" value="traveler">
                          </div>
                          <div class="row">
                          ...
                          <br>
                          <a href="login">If you are a registered Traveler, please click to login</a>
                      </form>
                  </div>
              </div>
            </div>
