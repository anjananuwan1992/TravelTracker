  ...
  <body class="signuppic">
    ...
    <div class="container d-flex justify-content-center">
      <div class="row border border-white border-3 rounded signupform">
        <div class="col-md">
            <div class="row">
                <div class="signupselect"><a class="signupa" href="Explorer">Register as an Explorer</a> </div><br>
                ...
                <div class="signupselect"><a class="signupa" href="travelerregistration">Register as a Traveler</a></div>
            </div>
        </div>
      </div>
    </div>