        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarnew">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item" style="background-color:brown; border-radius:5px;">
                <a class="nav-link" href="traveleroption">View Your Tours</a>
              </li>
            </ul>
             
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0" id="loginlink">
              ...
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="display: none;" id="logid">
