      ...
      <div class="col">
        ...
        <div class="container">
            @foreach($plans as $plan)
                <h2>{{$plan->t_name}}</h2>
                <input type="text" id="mapid" value="{{$plan->id}}"
                <br>
                <div class="row overflow-auto border border-dark border-3" style= "height:78vh;">
                    <div class="row">
                        ...
                        @foreach($businesses as $business)
                            ...
                            <hr>
                            <div class="row">
                                <div class="col-md-6" id="{{$plan->id}}" style="margin-top:10px; height:70vh;"></div>
            ...
            const request = {
                ...
                destination: waypoints[filteredWaypoints.length - 2].location,
                waypoints: filteredWaypoints.slice(1, -2),
