...
use App\Http\Controllers\travelerController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('/travelerregistration', function () {
    return view('travelerregistration');
});
...
Route::get('/travellist/logout', [CustomAuthController::class, 'logouttravel']);
...
Route::post('/pendingaccounts', [adminController::class, 'activeuser3'])->name('active3.user');
...
Route::get('/view-plan', [ViewPlanController::class, 'viewPlan'])->name('view.plan')->middleware('isLoggedIn');

Route::post('/view-plan', [ViewPlanController::class, 'saveplan'])->name('save.plan');
...
Route::post('/travelerregistration', [travelerController::class, 'registertraveler'])->name('register-traveler');

Route::get('/travelerdashboard', [travelerController::class, 'travelerdashboard'])->middleware('isLoggedIn');

Route::get('/traveleroption', [travelerController::class, 'traveleroption'])->middleware('isLoggedIn');

Route::get('/travellist/{id}', [travelerController::class, 'travellist'])->middleware('isLoggedIn');


Route::get('/verify_otp', [CustomAuthController::class, 'verifyOTP'])->name('verify.otp');
Route::post('/send_otp', [CustomAuthController::class, 'sendOTP'])->name('send.otp');
Route::get('/reset_password', [CustomAuthController::class, 'resetPassword'])->name('reset.password');
